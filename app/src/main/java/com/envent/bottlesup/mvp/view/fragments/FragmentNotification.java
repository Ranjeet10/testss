...
public class FragmentNotification extends LogoutMethodFragment implements MVPView.NotificationView {

    private Unbinder unbinder;
    private List<ItemsItem> notifications = new ArrayList<>();
    private MyPresenter.NotificationPresenter presenter;
    protected BroadcastReceiver notificationDeleteReceiver;
    ...
    private void setUpBroadCast() {
        notificationDeleteReceiver = new BroadcastReceiver() {
            @Override
        ...
        IntentFilter filter = new IntentFilter(MetaData.INTENT_ACTIONS.NOTIFICATION_DELETE_ACTION);
        LocalBroadcastManager.getInstance(getContext()).registerReceiver(notificationDeleteReceiver, filter);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), ((recyclerView1, v, position) -> {
            ...
            dIntent.putExtra(MetaData.KEY.NOTIFICATION_TYPE, MetaData.KEY.NOTIFICATION_TYPE_NOTIFICATION);
    ...
    public void onDestroyView() {
        super.onDestroyView();
        unbinder.unbind();
        LocalBroadcastManager.getInstance(getContext()).unregisterReceiver(notificationDeleteReceiver);
    }
